(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('svelte'), require('rxjs'), require('rxjs/operators')) :
  typeof define === 'function' && define.amd ? define(['exports', 'svelte', 'rxjs', 'rxjs/operators'], factory) :
  (global = global || self, factory(global.sx = {}, global.svelte, global.rxjs, global.operators));
}(this, function (exports, svelte, rxjs, operators) { 'use strict';
  ...
  const createConnector = ({ onDestroy }) => {
    ...
    const wrapSink = rxjs.pipe(createWriter, makeAssignable);
